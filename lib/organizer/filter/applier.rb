module Organizer
  module Filter
    module Applier
      ...
      def self.apply_groups_filters(_filters, _groups_collection, _groups_filters)
        ...
        _groups_collection.each { |item| apply_groups_filters(_filters, item, _groups_filters) }
      end
